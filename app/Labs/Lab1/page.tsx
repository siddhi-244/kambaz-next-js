    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          ...
          <li>
            Prepare the pizza dough and roll it out into a circle or rectangle.
          </li>
          <li>Place the dough on a baking tray or pizza stone.</li>
          <li>Spread pizza sauce evenly over the dough.</li>
          <li>Sprinkle shredded mozzarella cheese on top of the sauce.</li>
          <li>
            Add your favorite toppings (pepperoni, vegetables, mushrooms, etc.).
          </li>
          <li>
            Sprinkle a little more cheese and herbs (oregano, basil) for extra
            flavor.
          </li>
          <li>
            Bake the pizza in the oven for 10–15 minutes until the crust is
            golden brown.
          </li>
          <li>Remove from the oven and let it cool for 2–3 minutes.</li>
      ...
      <div id="wd-forms">
        ...
        <form id="wd-text-fields">
          ...
          <br />
          <select multiple id="wd-select-many-genre" defaultValue="COMEDY">
            <option value="COMEDY">Comedy</option>
            <option value="DRAMA"> Drama </option>
            <option value="SCIFI">Science Fiction</option>
            <option value="FANTASY"> Fantasy </option>
        ...
        <br />
        Please
        <a href="https://github.com/siddhi-244/kambaz-next-js" id="wd-github">
          click here
        </a>
